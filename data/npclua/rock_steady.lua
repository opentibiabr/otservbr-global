...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "collect") then
		if player:getStorageValue(72326) == 1 then
			npcHandler:say("I collect everything that reflects light in strange ways. However, I am bored by my collection. And there wasn't anything new to add for years. ...", npc, creature)
			npcHandler:say("I like pearls for example - but I have already enough. I also like shells - but I can't even count how many I already own. ...", npc, creature)
		...
		elseif player:getStorageValue(72326) == 4 and player:removeItem(14021, 1) then
			npcHandler:say("Have you got anything... what? You want what? A reward? HAHAHAHAAAA!! ...", npc, creature)
			npcHandler:say("No I'm just teasing you. I'm really happy about my collection now. ...", npc, creature)
