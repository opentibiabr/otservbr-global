...
monster.attacks = {
	{name ="melee", interval = 1000, chance = 100, minDamage = 0, maxDamage = -1}
}

monster.defenses = {
	defense = 5,
	armor = 5,
	{name ="combat", interval = 10000, chance = 100, type = COMBAT_HEALING, minDamage = 24000, maxDamage = 24000, effect = CONST_ME_MAGIC_BLUE, target = false}
}
