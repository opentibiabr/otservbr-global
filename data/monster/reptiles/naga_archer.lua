...
monster.attacks = {
	...
	{name ="combat", interval = 6000, chance = 39, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -2200, length = 5, spread = 3, effect = CONST_ME_MORTAREA},
    {name ="combat", interval = 3000, chance = 68, minDamage = -400, maxDamage = -600, type = COMBAT_DEATHDAMAGE, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true},
