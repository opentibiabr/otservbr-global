...
monster.loot = {
	...
	{name = "blue crystal shard", chance = 4000, maxCount = 3},
	...
	{name = "cyan crystal fragment", chance = 4650, maxCount = 3},
	{name = "violet crystal shard", chance = 3650, maxCount = 3},
	{name = "red crystal fragment", chance = 4650, maxCount = 3},
	{name = "rainbow quartz", chance = 6980, maxCount = 1},
	{name = "onyx chip", chance = 4650, maxCount = 4},
	{name = "yellow gem", chance = 2330, maxCount = 1},
	{name = "green crystal fragment", chance = 9300, maxCount = 3},
	...
	{id = 3097, chance = 2330, maxCount = 1} -- dwarven ring
}
