...
function beaverTrees.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if toPosition == config.treesBeaver[1] or toPosition == config.treesBeaver[2] or toPosition == config.treesBeaver[3] and player:getStorageValue(TheNewFrontier.Questline) == 5 then
		if toPosition == config.treesBeaver[1] and player:getStorageValue(TheNewFrontier.Beaver1) < 1 then
			for i = 1, 3 do
				pos = toPosition
		...
		elseif toPosition == config.treesBeaver[2] and player:getStorageValue(TheNewFrontier.Beaver2) < 1 then
			for i = 1, 5 do
				pos = toPosition
		...
		elseif toPosition == config.treesBeaver[3] and player:getStorageValue(TheNewFrontier.Beaver3) < 1 then
