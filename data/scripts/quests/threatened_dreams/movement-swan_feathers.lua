local config = {
        ...
        [25028] = {
            ...
            storage = Storage.Quest.ThreatenedDreams.Mission01.Feathers5}
    }
...
function swanFeathers.onStepIn(creature, item, position, fromPosition)
    ...
    if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) ~= 13 then
        return true
    end
    ...
    if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01.FeathersCount) < 5 then
        player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01.FeathersCount, player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01.FeathersCount)+1)
        ...
        if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01.FeathersCount) == 5 then
            player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 14) -- Finish the mission
        end
        return true
    end
end
