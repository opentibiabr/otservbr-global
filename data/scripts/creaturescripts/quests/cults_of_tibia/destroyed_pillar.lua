	...
	for i = 1, #pillar do
		...
		if monsterName == pilar:lower() then
			if monsterName:find(summoning) then
				...
				Game.createMonster("Eshtaba The Conjurer", newpos, true, true):registerEvent("EssenceOfMalice")
			elseif monsterName:find(death) then
				...
				Game.createMonster("Destroyed Pillar", position, true, true)
				Game.createMonster("Malkhar Deathbringer", newpos, true, true):registerEvent("EssenceOfMalice")
			elseif monsterName:find(healing) then
				...
				Game.createMonster("Destroyed Pillar", position, true, true)
				Game.createMonster("Mezlon The Defiler", newpos, true, true):registerEvent("EssenceOfMalice")
			elseif monsterName:find(protection) then
				...
				Game.createMonster("Destroyed Pillar", position, true, true)
				Game.createMonster("Eliz The Unyielding", newpos, true, true):registerEvent("EssenceOfMalice")
			elseif monsterName:find(draining) then
				...
				Game.createMonster("Destroyed Pillar", position, true, true)
				Game.createMonster("Dorokoll The Mystic", newpos, true, true):registerEvent("EssenceOfMalice")
			end
		end
	end
	return true
