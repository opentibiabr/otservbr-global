...
function explorerSocietyStone.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	elseif target.aid == 14171 and player:getStorageValue(Storage.ExplorerSociety.TheSpectralStone) == 54 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 54 and player:getStorageValue(Storage.ExplorerSociety.SpectralStone) == 1 then -- mission taken from Angus
		...
		toPosition:sendMagicEffect(CONST_ME_MAGIC_BLUE)
	elseif target.aid == 14171 and player:getStorageValue(Storage.ExplorerSociety.TheSpectralStone) == 53 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 53 and player:getStorageValue(Storage.ExplorerSociety.SpectralStone) == 2 then -- mission taken from Mortimer
		player:setStorageValue(Storage.ExplorerSociety.TheSpectralStone, 54)
		player:setStorageValue(Storage.ExplorerSociety.QuestLine, 54)
		toPosition:sendMagicEffect(CONST_ME_MAGIC_BLUE)
