...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		...
		and player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission03[1]) <= 3 then
			npcHandler:say({
	...
	elseif MsgContains(message, "starlight vial") or MsgContains(message, "empty starlight vial") then
		if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission03[1]) == 4 then
			if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission03.EmptyStarlightVial) < 1 then
				npcHandler:say({
				...
				player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission03.EmptyStarlightVial, 1)
				npcHandler:setTopic(playerId, 0)
			else
				npcHandler:say({
