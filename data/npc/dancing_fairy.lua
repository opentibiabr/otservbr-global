...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "spell") then
		if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission03[1]) == 1
		and player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission03.UnlikelyCouple) == 1 then
			npcHandler:say({
			...
			player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission03.UnlikelyCouple, 2)
