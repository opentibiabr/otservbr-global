...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Venha fazer seu addons." },
	{ text = "Ninguem quer Fazer addons nao?? vou dormir... zzzz." },
	{ text = "Ei amigo ta esperando oque venha fazer seu addonzinho!" }
}
...
testeItems        = 'Test msg.'
	  ...
	  -- PHARAOH START -- 
function pharaohFirst(cid, message, keywords, parameters, node) 
    ...
    addon = getPlayerStorageValue(cid,pharaoh) 
    local player = Player(cid)
	if not player:hasOutfit(956, 2) and not player:hasOutfit(955, 2) then
        if getPlayerItemCount(cid,25377) >= 40 then 
        if doPlayerRemoveItem(cid,25377,40) then 
            selfSay(newaddon, cid) 
              
            doSendMagicEffect(getCreaturePosition(cid), 13) 
            doPlayerAddOutfit(cid, 956, 2) 
            doPlayerAddOutfit(cid, 955, 2) 
            setPlayerStorageValue(cid,pharaoh,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function pharaohSecond(cid, message, keywords, parameters, node) 
    ...
    if isPremium(cid) then 
    addon = getPlayerStorageValue(cid,pharaoh+1) 
    local player = Player(cid)
	if not player:hasOutfit(956, 1) and not player:hasOutfit(955, 1) then
        if getPlayerItemCount(cid,25377) >= 50 then 
        if doPlayerRemoveItem(cid,25377,50) then 
            selfSay(newaddon, cid) 
              
            doSendMagicEffect(getCreaturePosition(cid), 13) 
            doPlayerAddOutfit(cid, 956, 1) 
            doPlayerAddOutfit(cid, 955, 1) 
            setPlayerStorageValue(cid,pharaoh+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
-- PHARAOH END -- 
	  ...
	  -- FESTIVE START -- 
function festiveFirst(cid, message, keywords, parameters, node) 
    ...
    if isPremium(cid) then 
    addon = getPlayerStorageValue(cid,festive) 
     local player = Player(cid)
	if not player:hasOutfit(929, 2) and not player:hasOutfit(931, 2) then 
        if getPlayerItemCount(cid,28289) >= 3 then 
        if doPlayerRemoveItem(cid,28289,3) then 
            selfSay(newaddon, cid) 
              
            doSendMagicEffect(getCreaturePosition(cid), 13) 
            doPlayerAddOutfit(cid, 929, 2) 
            doPlayerAddOutfit(cid, 931, 2)
				player:addAchievement('Reason to Celebrate')
            setPlayerStorageValue(cid,festive,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function festiveSecond(cid, message, keywords, parameters, node) 
    ...
    if isPremium(cid) then 
    addon = getPlayerStorageValue(cid,festive+1) 
    local player = Player(cid)
	if not player:hasOutfit(929, 1) and not player:hasOutfit(931, 1) then  
        if getPlayerItemCount(cid,28290) >= 50 then 
        if doPlayerRemoveItem(cid,28290,50) then 
            selfSay(newaddon, cid) 
              
            doSendMagicEffect(getCreaturePosition(cid), 13) 
            doPlayerAddOutfit(cid, 929, 1) 
            doPlayerAddOutfit(cid, 931, 1) 
            setPlayerStorageValue(cid,festive+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function elementalistFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(432, 2) and not player:hasOutfit(433, 2) then 
...
function elementalistSecond(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(432, 1) and not player:hasOutfit(433, 1) then  
...
function riftFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(845, 1) and not player:hasOutfit(846, 1) then  
...
function riftSecond(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(845, 2) and not player:hasOutfit(846, 2) then 
...
function GloothFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(610, 1) and not player:hasOutfit(618, 1) then 
...
function GloothSecond(cid, message, keywords, parameters, node) 
   ...
   local player = Player(cid)
	if not player:hasOutfit(610, 2) and not player:hasOutfit(618, 2) then 
        if getPlayerItemCount(cid,21400) >= 10 then 
        if doPlayerRemoveItem(cid,21400,10) then 
            selfSay(newaddon, cid) 
			...
			player:addAchievement('Glooth Engineer')
...
function YalaharianFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(324, 1) and not player:hasOutfit(325, 1) then  
        if getPlayerItemCount(cid,21400) >= 10 then 
        if doPlayerRemoveItem(cid,21400,10) then 
            selfSay(newaddon, cid) 
...
function YalaharianSecond(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(324, 2) and not player:hasOutfit(325, 2) then
        if getPlayerItemCount(cid,21400) >= 10 then 
        if doPlayerRemoveItem(cid,21400,10) then 
            selfSay(newaddon, cid) 
...
function PumpkinFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(759, 1) and not player:hasOutfit(760, 1) then 
...
function PumpkinSecond(cid, message, keywords, parameters, node) 
    ...
    addon = getPlayerStorageValue(cid,pumpkin+1) 
     local player = Player(cid)
	if not player:hasOutfit(759, 2) and not player:hasOutfit(760, 2) then 
        if getPlayerItemCount(cid,21400) >= 20 then 
        if doPlayerRemoveItem(cid,21400,20) then 
            selfSay(newaddon, cid) 
...
function HunterFirst(cid, message, keywords, parameters, node) 
	...
	if not player:hasOutfit(129, 1) and not player:hasOutfit(137, 1) then
	 if getPlayerSex(cid) == 1 then -- PLAYERSEX == 1 é female
...
function MageSecond(cid, message, keywords, parameters, node) 
    ...
    if addon < 2 then 
		...
		-- aqui é pra deixar só selfSay(already, cid)
...
function SummonerFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(133, 1) and not player:hasOutfit(141, 1) then 
...
function SummonerSecond(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(133, 2) and not player:hasOutfit(141, 2) then
        if getPlayerSex(cid) == 1 then -- PLAYERSEX == 1 é male
        if getPlayerItemCount(cid,5894) >= 70 and getPlayerItemCount(cid,5911) >= 20 and getPlayerItemCount(cid,5883) >= 40 and getPlayerItemCount(cid,5922) >= 35 and getPlayerItemCount(cid,5886) >= 10 and getPlayerItemCount(cid,5881) >= 60 and getPlayerItemCount(cid,5882) >= 40 and getPlayerItemCount(cid,5904) >= 15 and getPlayerItemCount(cid,5905) >= 30 then 
        if doPlayerRemoveItem(cid,5894,70) and doPlayerRemoveItem(cid,5911,20) and doPlayerRemoveItem(cid,5883,40) and doPlayerRemoveItem(cid,5922,35) and doPlayerRemoveItem(cid,5886,10) and doPlayerRemoveItem(cid,5881,60) and doPlayerRemoveItem(cid,5882,40) and doPlayerRemoveItem(cid,5904,15) and doPlayerRemoveItem(cid,5905,30) then 
            selfSay(newaddon, cid) 
...
function DruidSecond(cid, message, keywords, parameters, node) 
	...
	-- aqui no lugar do 5939 estava 5938
...
function NightmareSecond(cid, message, keywords, parameters, node) 
	...
	if player:getStorageValue(nightmare) <= 0 then 
	npcHandler:say("Sorry, you need the first nightmare addon before.", cid)	
	return false 
	end
...
function JesterFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(273, 1) and not player:hasOutfit(270, 1) then 
...
function JesterSecond(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(273, 2) and not player:hasOutfit(270, 2) then  
...
function BrotherhoodSecond(cid, message, keywords, parameters, node) 
	...
	if player:getStorageValue(brotherhood) <= 0 then 
	npcHandler:say("Sorry, you need the first brotherhood addon before.", cid)	
	return false 
	end
...
function WayfarerFirst(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(366, 1) and not player:hasOutfit(367, 1) then 
...
function WayfarerSecond(cid, message, keywords, parameters, node) 
    ...
    local player = Player(cid)
	if not player:hasOutfit(366, 2) and not player:hasOutfit(367, 2) then 
        ...
        if doPlayerRemoveItem(cid,12656,1) then 
			...
			player:addAchievement('Peazzekeeper')
...
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "What you do is that you type 'first hunter addon' or 'second hunter addon' where you replace 'hunter' with whatever outfit you'd like to achieve the addons for. Assuming that you already collected all the required pieces, say 'yes' and voíla - you got yourself an addon!"}) 
 ...
 node4 = keywordHandler:addKeyword({'second hunter addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second hunter addon you need to give me a pair of sniper gloves if you are a {male}. Otherwise if you are {female}, you need to give me Elane Crossbow, 100 lizard leathers, 100 red dragon leather, 5 enchanted chicken wings, a piece of royal steel, a piece of hell steel and a piece of draconian steel. Do you have them with you?'}) 
 ...
 node5 = keywordHandler:addKeyword({'first mage addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first mage addon you need to give me a winning lottery ticket if you are a {female}. Otherwise if you are {male}, you need to give me all kind of wands and rods, 10 magic sulphurs, 20 ankhs and a soul stone. Do you have it with you?'}) 
 ...
 node15 = keywordHandler:addKeyword({'first barbarian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first barbarian addon you need to give me 100 iron ore, a chunk of crude iron, 50 behemoth fangs and 50 lizard leathers. Do you have them with you?'}) 
 ...
 node16 = keywordHandler:addKeyword({'second barbarian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second barbarian addon you need to give me a fighting spirit, the warrior\'s sweat, 50 red pieces of cloth, 50 green pieces of cloth and 10 spool of yarns. Do you have them with you?'}) 
 ...
 node18 = keywordHandler:addKeyword({'second druid addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second druid addon you need to give me Botanist\'s Container, Ceiron\'s waterskin, 100 demon dusts and Ceiron\'s wolf tooth chain. Do you have them with you?'}) 
 ...
 node19 = keywordHandler:addKeyword({'second wizard addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second wizard addon you need to give me a dragon scale mail, a pair of crown legs, a medusa shield and a ring of the sky. Do you have them with you?'}) 
    node19:addChildKeyword({'yes'}, WizardSecond, {}) 
 ...
 node20 = keywordHandler:addKeyword({'first wizard addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first wizard addon you need to give me 50 holy orchids. Do you have them with you?'}) 
    node20:addChildKeyword({'yes'}, WizardFirst, {}) 
 ...
 node29 = keywordHandler:addKeyword({'second shaman addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second shaman addon you need to give me 5 dworc voodoo dolls and a mandrake. Do you have them with you?'}) 
 ...
 node38 = keywordHandler:addKeyword({'second brotherhood addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second brotherhood addon you need to give me 1500 demonic essences (you will receive Necromancer Shield). Do you have them with you?'}) 
	...
	node47 = keywordHandler:addKeyword({'firstfsdsdfsdrift warrior addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Rift Warrior addon you need to give me 3 Gold Tokens. Do you have them with you?'}) 
	...
	node48 = keywordHandler:addKeyword({'seconddfsdfwarrior addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Rift Warrior addon you need to give me 200 Silver Tokens. Do you have them with you?'}) 
...
-- elementalist end
 ...
 -- festive 
    node51 = keywordHandler:addKeyword({'first festive addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Festive addon you need to give me 3 Porcelain Masks. Do you have them with you?'}) 
    node51:addChildKeyword({'yes'}, festiveFirst, {}) 
	...
	node52 = keywordHandler:addKeyword({'second festive addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Festive addon you need to give me 50 Colourful Feathers. Do you have them with you?'}) 
    node52:addChildKeyword({'yes'}, festiveSecond, {}) 
...
-- pharaoh 
    node53 = keywordHandler:addKeyword({'first pharaoh addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Pharaoh addon you need to give me 40 Gold Tokens. Do you have them with you?'}) 
    node53:addChildKeyword({'yes'}, pharaohFirst, {}) 
	...
	node54 = keywordHandler:addKeyword({'second pharaoh addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Pharaoh addon you need to give me 50 Gold Tokens. Do you have them with you?'}) 
    node54:addChildKeyword({'yes'}, pharaohSecond, {}) 
...
npcHandler:setMessage(MESSAGE_GREET, "Oh hello, nice to see you |PLAYERNAME|. \z
									  Are you here to hear some stories of my {help} or do you need {addons}?")
