...
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia} on {Darama}, to {Kazordoon}, to {Svargrond} on Hrodmir, to {Edron}, to the {Femor Hills} or to {Issavi} if you like. Where do you want to go?'})
keywordHandler:addKeyword({'tibia'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia} on {Darama}, to {Kazordoon}, to {Svargrond} on Hrodmir, to {Edron}, to the {Femor Hills} or to {Issavi} if you like. Where do you want to go?'})
keywordHandler:addKeyword({'ride'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia} on {Darama}, to {Kazordoon}, to {Svargrond} on Hrodmir, to {Edron}, to the {Femor Hills} or to {Issavi} if you like. Where do you want to go?'})
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia} on {Darama}, to {Kazordoon}, to {Svargrond} on Hrodmir, to {Edron}, to the {Femor Hills} or to {Issavi} if you like. Where do you want to go?'})
keywordHandler:addKeyword({'transport'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia} on {Darama}, to {Kazordoon}, to {Svargrond} on Hrodmir, to {Edron}, to the {Femor Hills} or to {Issavi} if you like. Where do you want to go?'})
