...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 5 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 9 then
			...
			player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 10)
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) >= 10 then
			npcHandler:say("I guess I will stick around for a time to watch over the grave. After this final watch I will find peace, I can feel this. Thank you, human being. You redeemed me.", npc, creature)
			npcHandler:setTopic(playerId, 0)
		else
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 6)
			npcHandler:setTopic(playerId, 0)
		end
