...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 1
			and player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01.PoacherChest) == 1 then
			npcHandler:say({
				"Uhmn.. Maybe Ahmet in Ankrahmun can help we to fake this book."
			}, npc, creature)
		elseif player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 2 then
			npcHandler:say({
				"The poachers are still chasing me. Please hurry and find a way to help me."
			}, npc, creature)
		elseif player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 3 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 15 then
			npcHandler:say({
			...
			player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 16)
		else
			npcHandler:say({
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			if player:getStorageValue(Storage.Quest.ThreatenedDreams.QuestLine) == 1 then
				...
				player:setStorageValue(Storage.Quest.ThreatenedDreams.QuestLine, 1)
				player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 1)
				npcHandler:setTopic(playerId, 0)
			end
		elseif npcHandler:getTopic(playerId) == 2 then
			...
			player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 4)
			npcHandler:setTopic(playerId, 0)
		end
