    ...
    elseif playerStatus == PROPOSED_STATUS then
        ...
        elseif candidate == player:getGuid() then
            ...
            if player:getItemCount(ITEM_WEDDING_RING) == 0 then
                npcHandler:say('As I said, you need a wedding ring and wedding outfit in order to marry.', cid)
            else
...
local node1 = keywordHandler:addKeyword({'marry'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Would you like to get married? Make sure you have a wedding ring and wedding outfit with you.'})
