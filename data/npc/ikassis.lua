...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 4 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 10 then
			...
			player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 11)
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 5)
			npcHandler:setTopic(playerId, 0)
		end
