...
function HirelingsInit()
	...
	if rows then
		repeat
			...
			hireling.posx = Result.get16(rows, "posx")
			hireling.posy = Result.get16(rows, "posy")
			hireling.posz = Result.get8(rows, "posz")
			hireling.lookbody = Result.get16(rows, "lookbody")
			hireling.lookfeet = Result.get16(rows, "lookfeet")
			hireling.lookhead = Result.get16(rows, "lookhead")
			hireling.looklegs = Result.get16(rows, "looklegs")
			hireling.looktype = Result.get16(rows, "looktype")
